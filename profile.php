	...
	<body>
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<span class="avatar"><img src="<?php echo ($_SESSION['pp'] == NULL)? 'images/avatar.jpg':'php/'.$_SESSION['path']."/".$_SESSION['pp'];?>" alt="" /></span>
						<h1>&nbsp;&nbsp;<?=$_SESSION['fname']." ".$_SESSION['lname']?></h1>
						<ul class="icons">
							<li><a target="_blank" href="<?php echo (($_SESSION['fb'] == NULL)?'#':"http://www.".$_SESSION['fb']); ?>" class="icon style2 fa-facebook"><span class="label">Facebook</span></a></li>
							<li><a target="_blank" href="<?php echo (($_SESSION['tweet'] == NULL)?'#':"http://www.".$_SESSION['tweet']); ?>" class="icon style2 fa-twitter"><span class="label">Instagram</span></a></li>
							<li><a target="_blank" href="<?php echo (($_SESSION['insta'] == NULL)?'#':"http://www.".$_SESSION['insta']); ?>" class="icon style2 fa-instagram"><span class="label">Instagram</span></a></li>
						</ul>
						<center>
