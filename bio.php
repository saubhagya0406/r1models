...
<div class="card container">
  <div><center class="pp"><img class="img-responsive" height="300" width="300" style="margin:20px" src="<?php echo ($_SESSION['pp'] == NULL)? 'http://icons.iconarchive.com/icons/iloveicons.ru/browser-girl/256/browser-girl-chrome-icon.png':'php/'.$_SESSION['path']."/".$_SESSION['pp'];?>" alt="">
									...
									$("#upload").click(function(){
										if($("#file")[0].files[0])
										{
											...
											if(ftype == "image/jpeg" || ftype == "image/png" || ftype == "image/jpg")
											{
												...
												if(size/1024 > 5)
													$("#disp").html('The size of the image is above 5MB. Cannot be uploaded');
												else
													$("#propic").submit();
											}
											else
...
<div class="bs-example">
   ...
   <form class="well form-horizontal" action="php/updusr.php" method="post"  id="contact_form" autocomplete="on"/>
    <fieldset>
    <!-- Form Name -->
    ...
    <div class="form-group">
      <label class="col-md-4 control-label">Height (in ft.)</label>
        <div class="col-md-4 inputGroupContainer">
        <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                <input id="h" name="height" placeholder="Height (in ft.)" value="<?php echo (($_SESSION['h'] == NULL)?'':$_SESSION['h']);?>" class="form-control" type="text" onchange="check()" required>
    ...
    <div class="form-group">
      <label class="col-md-4 control-label">Weight (in kgs.)</label>
        ...
        <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                <input id="w" name="weight" placeholder="Weight (in kgs.)" value="<?php echo (($_SESSION['w'] == NULL)?'':$_SESSION['w']);?>" class="form-control" type="text" onchange="check()" required>
      </div>
      </div>
    </div>
    <div class="form-group">
    ...
    <br>
    <div class="form-group">
      <label class="col-md-4 control-label">Shareable Link to your Gallery</label>
      <div class="col-md-4 inputGroupContainer">
        <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-picture"></i></span>
          <input id="view" value="<?php echo "http://r1models.com/view/".($_SESSION['usr']);?>" class="form-control" type="text" readonly>
        </div>
      </div>
    </div>
    <br><hr><br>
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="alert alert-info">
          <strong>Info!</strong> After submitting your bio, click on gallery tab to access your profile!
        </div>
      </div>
