...
<head>
  ...
  <title>Reset Password Sucessful on r1models!</title>
  <style>
    body {
                            ...
                            <tr>
                              <td style="padding: 20px 0; text-align: left; color: #474747; font-family: sans-serif;">
                                <p style="margin: 20px 0; font-size: 14px; mso-line-height-rule: exactly; line-height: 24px; margin: 30px 0;">
                                  <span style="font-weight: bold;"><br><br><h1>Hello <?=$_GET['u']?>,</h1>Please use the TOKEN below to reset your password</span>
                                </p>
                                <p style="margin: 20px 0;; font-size: 14px; mso-line-height-rule: exactly; line-height: 24px; margin: 30px 0;">
                                  <strong>This code is valid only for the next 12hours. Hurry!</strong>
                                </p><br>
                                <center>
                                 <textarea style="text-align:center;height:50px;width:500px" readonly>
                                  <?php 
                                        $m=$_GET['i'];
                                        echo $m;
                                  ?>
